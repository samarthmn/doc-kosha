-- Viewer-insights exports can contain verified viewer email addresses.
-- Keep the direct security-definer RPC owner-only as well as the HTTP route.
...
as $$
  ...
  where v.workspace_id = p_workspace_id
    ...
    and public.has_workspace_role(p_workspace_id, array['owner'::text])
