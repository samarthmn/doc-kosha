...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        // Matches popover.tsx: fade + 4px slide from the trigger's side, 150ms
        // each way, no zoom entrance.
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ref={ref}
    className={cn(
      "relative flex cursor-pointer items-center rounded py-1.5 pr-2 pl-8 text-sm transition-colors outline-none select-none focus:bg-primary/10 focus:text-foreground data-disabled:pointer-events-none data-disabled:opacity-[var(--dk-disabled-opacity)]",
      className,
    )}
    {...props}
  >
